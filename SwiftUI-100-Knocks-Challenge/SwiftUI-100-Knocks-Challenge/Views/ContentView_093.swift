...
/// Markdown を表示する
struct ContentView_093: ViewWithTitle {
    let title: String = "093: Markdown を表示する(Heading, Paragraph)"
    ...
    var body: some View {
        ScrollView {
            try? Text(AttributedString(styledMarkdown: text))
                .padding()
        }

...
extension ContentViewData {
    static let testViewData: [ContentViewData] = [
        ...
        ContentViewData(ContentView_061()),
        ContentViewData(ContentView_062()),
        ContentViewData(ContentView_063()),
        ContentViewData(ContentView_064()),
        ...
        ContentViewData(ContentView_082()),
        ContentViewData(ContentView_083()),
        ContentViewData(ContentView_084()),
        ContentViewData(ContentView_085()),
        ContentViewData(ContentView_086()),
        ...
        ContentViewData(ContentView_094()),
        ContentViewData(ContentView_095()),
    ]
}
